...
де $\ell$ --- функція перехресної ентропії, $\lambda$ --- коефіцієнт
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\linewidth]{images/architecture.png}
...
де $\alpha \in [0,1]$ --- навчуваний параметр балансу гілок~\eqref{eq:fusion}.
